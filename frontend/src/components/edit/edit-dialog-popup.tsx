...
const EditDialogComponent: FC<DialogComponentProps> = (props: DialogComponentProps) => {
    ...
    return (  
      ...
      >
        ...
        <DialogContent dividers className={classes.dialogContent}>
            <Edit model={modelState} handleChange={handleChange} handleVariation={handleVariation} />
        </DialogContent>
        <DialogActions>
